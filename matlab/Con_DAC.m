...
block.Dwork(2).Data = randn(8,1);
block.Dwork(3).Data = block.DialogPrm(1).Data;
...
%block.Dwork(1).Data = zeros(32,1);
block.Dwork(1).Data = block.InputPort(1).Data + block.Dwork(2).Data;
%end Start
