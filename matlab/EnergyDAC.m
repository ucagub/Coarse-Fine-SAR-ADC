    ...
    load('js_energy_plots');
    plot(0:254,E_js_1Farad)
    plot(mean(E_js_1Farad).*ones(1,254))
...
EnergyCoarse(Vin+1) = Energy(Vin+1);
    ...
    legend('Conv','Avg. Conv','CapSplit','Avg. CapSplit','J-S','Avg. J-S','2-step JS','Avg 2-step JS')
