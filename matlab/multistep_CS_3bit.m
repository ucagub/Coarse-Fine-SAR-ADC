classdef multistep_CS_3bit < mother_DAC
    ...
    methods
        function obj = multistep_CS_3bit(N, varargin)
            ...
            obj@mother_DAC(N, Cu, 'multistep_CS_3bit');
            obj.skip_bits = skip_bits;
            [obj.SCA1_arraym , obj.SCA2_arraym] = obj.init_mismatch();
